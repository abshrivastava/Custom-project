(function () {
  ...
  function tangoService($http, $q) {
    ...
    function updateTransactionLogForGiftCard(data) {
      const REQUEST_URL = '/redemption-service/tango/metadata-update';
    ...
    function registerCC(data) {
      const REQUEST_URL = '/redemption-service/tango/cc/register';
    ...
    function unregisterCC(data) {
      const REQUEST_URL = '/redemption-service/tango/cc/unregister';
    ...
    function getCreditCards() {
      const REQUEST_URL = '/redemption-service/tango/cc/all';
