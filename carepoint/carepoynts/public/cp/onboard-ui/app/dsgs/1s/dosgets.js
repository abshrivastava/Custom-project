...
angular.module('app.dosgets1',[])

.controller('DosGetsCtrl1', ['$scope', '$q', '$state', '$stateParams', '$window', 'onboardService', function($scope, $q, $state, $stateParams, $window, onboardService) {
    const vm = $scope;
