...
function BindTable(item) {
    ...
    if (description != null && description != '' && description.length > 500) {
        $('#txtTableDescription').html(description.substr(0, 500) + '<span style="display: none;">' + description.substr(500) + '</span> <a onclick="ShowMore(this)">More...</a>');
    } else {
    ...
    if (technicalNotes != null && technicalNotes != '' && technicalNotes.length > 500) {
        $('#txtTechnicalNotes').html(technicalNotes.substr(0, 500) + '<span style="display: none;">' + technicalNotes.substr(500) + '</span> <a onclick="ShowMore(this)">More...</a>');
    } else {
    ...
    if (granularity != null && granularity != '' && granularity.length > 250) {
        $('#txtDataGranularity').html(granularity.substr(0, 250) + '<span style="display: none;">' + granularity.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>');
    } else {
    ...
    if (sApplication != null && sApplication != '' && sApplication.length > 250) {
        $('#txtSourceApplication').html(sApplication.substr(0, 250) + '<span style="display: none;">' + sApplication.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>');
    } else {
    ...
    if (sql != null && sql != '' && sql.length > 250) {
        $('#txtSQL').html(sql.substr(0, 250) + '<span style="display: none;">' + sql.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>');
    } else {
...
function BindLibraryMetadata(Items) {
    ...
    $(Items).each(function (index) {
        ...
        sb.append("<tr id='" + $(this)[0].ID + "'>"     
            +"<td style='padding: 7px;border: 1px solid #ddd;'> <a onClick='ShowDocument("+ServerRelativeUrl+")' style='cursor: pointer;'>" + Name + "</a></td>"
            +"</tr>");

    });
    $('#s4-workspace #tblERDiagram').html(sb.toString());
    console.log(Items);

}
function ShowDocument(loc) {
    var url = loc + "?web=1";
    document.getElementById('viewDocument').src = url;
    var anchDownload = document.getElementById('ancDownloadDoc');
    anchDownload.href = loc;
    $(anchDownload).parent().show();
             
}
function ClearDiagramData() {
    document.getElementById('viewDocument').src = '';
    var anchDownload = document.getElementById('ancDownloadDoc');   
    $(anchDownload).parent().hide();
}
//////////////End Documents//////////////////////////
///////////////Columns/////////////////////////////////
...
function BindColumnsTable(Items) {
    ...
    $(Items).each(function (index) {
        ...
        if (Formula != null && Formula != '' && Formula.length > 250) {
            formulaMore = Formula.substr(0, 250)  + '<span style="display: none;">' + Formula.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>';
        } else {
        ...
        if (DataSource != '' && DataSource.length > 250) {
            dataSourceMore = DataSource.substr(0, 250) + '<span style="display: none;">' + DataSource.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>';
        } else {
        ...
        if (SQLCode != '' && SQLCode.length > 250) {
            sqlCodeMore = SQLCode.substr(0, 250) + '<span style="display: none;">' + SQLCode.substr(250) + '</span> <a onclick="ShowMore(this)">More...</a>';
        } else {
            sqlCodeMore = $(this)[0].SQLCode != undefined && $(this)[0].SQLCode != null ? $(this)[0].SQLCode : '';
        }
       tr = tr +"<tr id=" + $(this)[0].ID + ">" +
             "<td><span class='label label-default'>" + (index + 1) + "</span></td>" +
             "<td id='tdColumnName'><a id='anchColumnName' onclick='GetTableByID(" + $(this)[0].ID + ");' data-toggle='modal' data-target='#ColumnModal' href='#'><span class='Pointer'>" + ColumnName + "</span></a>";
        if (Key.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Key : <span onclick='hideOnBlank(this);'>" + Key + "</span></p>";
        }
        if (Unique.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Unique : <span onclick='hideOnBlank(this);'>" + Unique + "</span></p>";
        }
        if (Identity.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Identity : <span onclick='hideOnBlank(this);'>" + Identity + "</span></p>";
        }
        if (Increment.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Increment : <span onclick='hideOnBlank(this);'>" + Increment + "</span></p>";
        }
        if (Seed.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Seed : <span onclick='hideOnBlank(this);'>" + Seed + "</span></p>";
        }
        if (Default.length > 0) {
            tr = tr + "<p style='margin:0;line-height:inherit;'>Default Value : <span onclick='hideOnBlank(this);'>" + Default + "</span></p>";
        }
       
          //  "<p style='margin:0;line-height:inherit;'>Unique : <span onclick='hideOnBlank(this);'>" + Unique + "</span></p>" +
           // "<p style='margin:0;line-height:inherit;'>Identity : <span onclick='hideOnBlank(this);'>" + Identity + "</span></p>" +
           // "<p style='margin:0;line-height:inherit;'>Increment : <span onclick='hideOnBlank(this);'>" + Increment + "</span></p>" +
           // "<p style='margin:0;line-height:inherit;'>Seed : <span onclick='hideOnBlank(this);'>" + Seed + "</span></p>" +
          tr = tr +  "</td>" +
            "<td class='descminspace'><span>" + ColumnDescription + "</span></td>" +
           "<td><pre style='width: 450px; white-space: pre-wrap;word-break: normal;' class='pre-height'><span>" + formulaMore + "</span></pre></td>" +
            "<td><pre style='width: 450px; white-space: pre-wrap;word-break: normal;' class='pre-height'><span>" + sqlCodeMore + "</span></pre></td>" +
            "<td><pre style='width: 450px; white-space: pre-wrap;word-break: normal;' class='pre-height'<span>" + dataSourceMore + "</span></pre></td>" +
